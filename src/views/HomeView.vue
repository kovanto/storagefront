    ...
    <div class="container text-center">
      <div class="row">
        <div class="col col-4" ><i>
          ...
          Üürileandjatele võimaldab SpaceLink kiiret kuulutuste avaldamist, suure ulatusega turundust ja lihtsat
          haldamist. Üürnike jaoks on saadaval mitmekesised rendivõimalused, kohandatud otsingufiltrid ning turvalisus
          ja tugi.<br>
